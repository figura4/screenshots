<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../screenshots/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['thumbnail.width'] = "144"; // px
	...
	$mcImageManagerConfig['thumbnail.jpeg_quality'] = 95; // quality of th image, note that this is not checked against when regenerating ths.
